...
var weightVlaue = flag.String("weight", "1", "weight vlaue")
...
func StartService() {
	...
	service := &registry.ServiceInfo{
		...
		Metadata:   metadata.Pairs(common.WeightKey, *weightVlaue),
	}
...
// go run main.go -node node1 -port 28544 -weight 1
// go run main.go -node node2 -port 18562 -weight 2
// go run main.go -node node3 -port 27772 -weight 3
func main() {
	flag.Parse()
	StartService()
}
