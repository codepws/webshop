...
var (
	...
	ErrJWTKeyEmpty     = NewError(10006, "加密用户密码时发生错误")
	...
	ErrTokenExpired = NewError(20202, "Token无效") //&Errno{Code: 20202, Message: "jwt 是无效的"}
	// 用户错误, 前缀为 203
	...
	ErrVerificationCodeExpired = NewError(20304, "验证码不存在")
	ErrVerificationCodeInvalid = NewError(20304, "验证码无效")
)
